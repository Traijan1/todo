...
<template>
  <div class="min-h-screen flex items-center justify-center bg-brand-background px-4">
    <div class="max-w-md w-full space-y-8 p-10 bg-brand-container rounded-3xl shadow-2xl border border-brand-primary/10">
      <div>
        ...
        <p class="mt-2 text-center text-sm text-brand-text-muted">
          Or
          <router-link to="/register" class="font-bold text-brand-secondary hover:text-brand-primary transition-colors underline decoration-brand-secondary/30 underline-offset-4">
